...
Map<String, ScenarioFactory> _scenarios = <String, ScenarioFactory>{
  ...
  'platform_view': () => PlatformViewScenario(
      window, 'Hello from Scenarios (Platform View)',
      id: _viewId++),
  ...
  'platform_view_multiple_without_overlays': () =>
      MultiPlatformViewWithoutOverlaysScenario(
          window, 'Hello from Scenarios (Platform View)',
          firstId: _viewId++, secondId: _viewId++),
  'platform_view_max_overlays': () => PlatformViewMaxOverlaysScenario(
      window, 'Hello from Scenarios (Platform View)',
      id: _viewId++),
  'platform_view_cliprect': () => PlatformViewClipRectScenario(
      window, 'PlatformViewClipRect',
      id: _viewId++),
  'platform_view_cliprrect': () => PlatformViewClipRRectScenario(
      window, 'PlatformViewClipRRect',
      id: _viewId++),
  'platform_view_clippath': () => PlatformViewClipPathScenario(
      window, 'PlatformViewClipPath',
      id: _viewId++),
  'platform_view_transform': () => PlatformViewTransformScenario(
      window, 'PlatformViewTransform',
      id: _viewId++),
  'platform_view_opacity': () =>
      PlatformViewOpacityScenario(window, 'PlatformViewOpacity', id: _viewId++),
  'platform_view_multiple': () =>
      MultiPlatformViewScenario(window, firstId: 6, secondId: _viewId++),
  'platform_view_multiple_background_foreground': () =>
      MultiPlatformViewBackgroundForegroundScenario(window,
          firstId: _viewId++, secondId: _viewId++),
  'poppable_screen': () => PoppableScreenScenario(window),
  'platform_view_rotate': () =>
      PlatformViewScenario(window, 'Rotate Platform View', id: _viewId++),
  'platform_view_gesture_reject_eager': () => PlatformViewForTouchIOSScenario(
      window, 'platform view touch',
      id: _viewId++, accept: false),
  'platform_view_gesture_accept': () => PlatformViewForTouchIOSScenario(
      window, 'platform view touch',
      id: _viewId++, accept: true),
  'platform_view_gesture_reject_after_touches_ended': () =>
      PlatformViewForTouchIOSScenario(window, 'platform view touch',
          id: _viewId++, accept: false, rejectUntilTouchesEnded: true),
  ...
  'platform_view_with_continuous_texture': () =>
      PlatformViewWithContinuousTexture(window, 'Platform View', id: _viewId++),
};
